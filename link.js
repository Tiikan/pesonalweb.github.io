...
ScrollReveal().reveal('.home-comtent, .heading ,.about-img2', { origin: 'top' });
...
const typed =new Typed('.multilpe-text',{
   strings: [' MATHEMATICS FOR COMPUTER  ','C++ PROGRAMMING II','WRITING SKILLS ENGLISH',
'WEB PAGE DYNAMICS' ,'WEB-BASED DEVELOPMENT I'],
   typeSpeed: 100,
   backSpeed: 100,
   backDelay: 1000,
   loop: true
